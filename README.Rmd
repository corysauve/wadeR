...
You can install the development version of wadeR from [GitHub](https://github.com/) with:
...
* Organic nitrogen
* Water Column Oxic (%)
* Carlson Trophic State Index (Secchi, Chlorophyll-a, Total Phosphorus)
...
The wader package is licensed under the MIT License. Please see the [LICENSE](LICENSE.md) for more details.
